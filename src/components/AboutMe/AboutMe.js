...
function AboutMe(){
    return (
        <div className='flex-1 w-full flex flex-col justify-center items-center bg-darkblue py-4 md:py-6 xl:py-12'>
            <h1 className='my-2 py-2'>About Me</h1>
            <div className='flex-1 mx-3 lg:mx-8 flex flex-wrap items-center justify-evenly'>
                ...
                <div className="w-11/12 max-w-xl mx-auto text-white">
                    ...
                    <p>Do I sound like a good fit for your team? I'd love to hear from you!</p>
                </div>
            </div>
        </div>
    );
